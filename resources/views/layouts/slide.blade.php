<div class="">
    ...
    <div id="carousel-example-3" class="carousel slide carousel-fade white-text" data-ride="carousel" data-interval="false">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <!-- First slide -->
            <div class="carousel-item active view hm-black-light" style="background-image: url('{{ asset("img/ilha.png")}}'); background-repeat: no-repeat; background-size: cover;">

                <!-- Caption -->
                <div class="full-bg-img flex-center white-text">
                    <ul class="animated fadeIn col-md-12">
                        <li>
                            <h1 class="h1-responsive">Refrigeração</h1></li>
                        <li>
                            <p>Melhores produtos para seu comércio</p>
                        </li>
                        <li>
            ...
            <!-- Second slide -->
            <div class="carousel-item view hm-black-light " style="background-image: url('{{ asset("img/self.png")}}'); background-repeat: no-repeat; background-size: cover;">
            ...
            <!-- Third slide -->
            <div class="carousel-item view hm-black-light" style="background-image: url('{{ asset("img/freezer.png")}}'); background-repeat: no-repeat; background-size: cover;">
